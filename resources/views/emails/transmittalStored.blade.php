...
<body>
    <p>Good day! The Department requester (<b>{{ $name }}</b>) has created a new transmittal with a No. <b>{{ $transmittalno }}</b>:</p>
    <br>
    <p>Purpose: <b>{{ $purpose }}</b></p>
    <p>Type: <b>{{ $transType }}</b></p>
    <p>Date and time submitted: <b>{{ $datesubmitted." ".$timesubmitted }}</b></p>
