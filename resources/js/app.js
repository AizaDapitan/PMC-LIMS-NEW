...
app.component(
    "edit_deptofficer-component",
    require("./components/deptofficer/edit_deptofficer.vue").default
);
app.component(
...
app.component(
    "transmittal_analyst-component",
    require("./components/analyst/transmittal_analyst.vue").default
);
app.component(
    "view_transmittal_analyst-component",
    require("./components/analyst/view_transmittal_analyst.vue").default
);
app.component(
    "receive_analyst-component",
    require("./components/analyst/receive_analyst.vue").default
);
app.component(
    "edit_transmittal_analyst-component",
...
app.component(
    "index_solutions_officer-component",
    require("./components/officer/index_solutions_officer.vue").default
);
app.component(
    "view_solutions_officer-component",
    require("./components/officer/view_solutions_officer.vue").default
);
app.component(
    "post_solutions_officer-component",
    require("./components/officer/post_solutions_officer.vue").default
);
