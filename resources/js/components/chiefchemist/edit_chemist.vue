        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-style1 mg-b-5">
              ...
              <li class="breadcrumb-item" aria-current="page">
                <a :href="dashboard">Chief Chemist</a>
              </li>
          ...
          <h4 class="mg-b-0 tx-spacing--1">Edit Chief Chemist</h4>
        </div>
      </div>
  ...
  export default {
    ...
    data() {
      return {
        errors_exist: false,
        errors: {},
        dashboard: this.$env_Url + "/chiefchemists/dashboard",
        form: {
          id: this.chemist.id,
          name: this.chemist.name,
          description: this.chemist.description,
          active: true,
          checked: this.chemist.active,
        },
      };
    },
    ...
    methods: {
      async update() {
        ...
        const res = await this.submit("post", "/chiefchemists/update", this.form, {
          headers: {
            "Content-Type":
        ...
        if (res.status === 200) {
          this.updmessage();
          window.location.href = this.$env_Url + "/chiefchemists/dashboard";
        } else {
