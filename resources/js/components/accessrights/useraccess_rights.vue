  ...
  <div class="container-fluid pd-x-0">
    ...
    >
      <div>
        ...
        <h4 class="mg-b-0 tx-spacing--1">List of Users Access Rights</h4>
      </div>
      <div>
        <div
          class="
          ...
          "
        >
          <label for="username" class="mb-lg-0 mr-lg-2">Username</label>
...
export default {
  ...
  methods: {
    ...
    async save() {
      const res = await this.submit("post", "/accessrights/storeUser", this.form, {
        headers: {
          "Content-Type":
    ...
    storeID(data) {
      ...
      var user_permissions = this.form.userPermissions;
      ...
      this.form.userPermissions = user_permissions;
    },    
  },
};
</script>
