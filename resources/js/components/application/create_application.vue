  ...
  <div class="container-fluid pd-x-0">
    ...
    >
      <div>
        ...
        <h4 class="mg-b-0 tx-spacing--1">Create New Scheduled Shutdown</h4>
      </div>
    </div>
    <form>
      ...
      <div class="row row-sm">
        <div class="col-lg-6">
          <div class="form-group">
            <label class="d-block">Date <span class="text-danger" aria-required="true">
              *
            </span></label>
            <input
              type="date"
          ...
          <div class="form-group">
            <label class="d-block">Time <span class="text-danger" aria-required="true">
              *
            </span></label>
            <input
              type="time"
          ...
          <div class="form-group">
            <label class="d-block">Reason <span class="text-danger" aria-required="true">
              *
            </span></label>
            <textarea
              class="form-control"
