  ...
  <div class="container-fluid pd-x-0">
    ...
    >
      <div>
        ...
        <h4 class="mg-b-0 tx-spacing--1">Manage Supervisors</h4>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    addNew() {
      window.location.href = this.$env_Url + "/supervisors/create";
    },

    editRole(data) {
      let src = data.data.id,
        alt = data.data.id;
      window.location.href = this.$env_Url + "/supervisors/edit/" + alt;
    },
