        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-style1 mg-b-5">
              ...
              <li class="breadcrumb-item" aria-current="page">
                <a :href="dashboard">Fire Assayer</a>
              </li>
          ...
          <h4 class="mg-b-0 tx-spacing--1">Edit Fire Assayer</h4>
        </div>
      </div>
  ...
  export default {
    ...
    data() {
      return {
        errors_exist: false,
        errors: {},
        dashboard: this.$env_Url + "/fireassayers/dashboard",
        form: {
          id: this.fireassayer.id,
          name: this.fireassayer.name,
          description: this.fireassayer.description,
          active: true,
          checked: this.fireassayer.active,
        },
      };
    },
    ...
    methods: {
      async update() {
        ...
        const res = await this.submit("post", "/fireassayers/update", this.form, {
          headers: {
            "Content-Type":
        ...
        if (res.status === 200) {
          this.updmessage();
          window.location.href = this.$env_Url + "/fireassayers/dashboard";
        } else {
