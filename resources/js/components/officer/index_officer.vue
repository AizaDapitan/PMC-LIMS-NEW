    ...
    <div class="container-fluid pd-x-0">
      ...
      >
        <div>
          ...
          <h4 class="mg-b-0 tx-spacing--1">Home/Dashboard - Officer</h4>
        </div>
      </div>
                ...
                <Column field="status" header="Status" :sortable="true">
                  <template #body="slotProps">
                    <span
                      ...
                      >Posted</span
                    >
                    <span v-else  class="badge badge-info tx-uppercase">Saved</span>
                  </template>
                </Column>
                <Column
                  :exportable="false"
    ...
    methods: {
      ...
      viewWorksheet(data) {
        let src = data.data.id,
          alt = data.data.id;
        window.location.href = this.$env_Url + "/officer/view/" + alt;
      },
      exportCSV() {
      ...
      editWorksheet(data) {
        let src = data.data.id,
          alt = data.data.id;
        window.location.href = this.$env_Url + "/officer/edit/" + alt;
      },
    },
  };
  </script>