<template>
        ...
        <div>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-style1 mg-b-10">
              ...
              <li class="breadcrumb-item active" aria-current="page">Post Solution Transmittal</li>
            </ol>
          </nav>
          <h4 class="mg-b-0 tx-spacing--1">
            Post Solution Transmittal - Officer
          </h4>
        </div>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      async postTransmittal() {
        this.$confirm.require({
          message: "Do you want to post this transmittal?",
          ...
          accept: async () => {
            ...
            if (res.status === 200) {
              this.updmessage();
              window.location.href = this.$env_Url + "/officer/Solutions-dashboard";
            } else {
