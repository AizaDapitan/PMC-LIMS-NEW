<template>
    <div class="container-fluid pd-x-0">
      ...
      >
        <div>
          ...
          <h4 class="mg-b-0 tx-spacing--1">UnPost Worksheet - Officer</h4>
        </div>
      </div>
        ...
        <div class="col-lg-4">
          <div class="border p-2 p-lg-3 rounded mb-3">
            <div class="row row-sm">
              <div class="col-lg-6">
                <div class="form-group">
                  <label for="date-shift-weighed1">Date and Shift Weighed</label>
                  <input
                    type="text"
                    class="form-control"
                    id="date-shift-weighed1"
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  <label for="date-shift-weighed2">&nbsp;</label>
                  <input
                    type="text"
                    class="form-control"
          ...
          <div class="form-group">
            <label for="microbalance-no-check-weights"
              >Microbalance No. and Check Weights</label
            >
            <input
              type="text"
              class="form-control"
          ...
          <div class="form-group">
            <label for="analyzed-by">Analyzed By</label>
            <select
              class="custom-select tx-base"
              id="analyzed-by"
              name="analyzed-by"
      ...
      <div class="row flex-column-reverse flex-lg-row">
        ...
        <div class="col-lg-6 d-flex justify-content-start justify-content-lg-end">
          <button
            ...
            @click.prevent="unpost"
          >
            <i data-feather="check-circle" class="mg-r-5"></i> UnPost
          </button>
        </div>
      </div>
  ...
  export default {
    ...
    data() {
      return {
        dashboard: this.$env_Url + "/officer/posted",
        loading: true,
        items: [],
        errors_exist: false,
        errors: {},
        ...
        form: {
          ...
          isPosted : this.worksheet.isPosted
        },
      };
    },
    created() {
    ...
    methods: {
      ...
      async unpost() {
        const res = await this.submit("post", "/officer/updateposted", this.form, {
          headers: {
            "Content-Type":
        ...
        if (res.status === 200) {
          window.location.href = this.$env_Url + "/officer/posted";
        } else {
