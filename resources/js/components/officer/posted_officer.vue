    ...
    <div class="container-fluid pd-x-0">
      ...
      >
        <div>
          ...
          <h4 class="mg-b-0 tx-spacing--1">Home/Posted Dashboard - Officer</h4>
        </div>
      </div>
    ...
    methods: {
      ...
      viewWorksheet(data) {
        let src = data.data.id,
          alt = data.data.id;
        window.location.href = this.$env_Url + "/officer/view-posted/" + alt;
      },
      exportCSV() {
      ...
      editWorksheet(data) {
        let src = data.data.id,
          alt = data.data.id;
        window.location.href = this.$env_Url + "/officer/unpost/" + alt;
      },
    },
  };
  </script>