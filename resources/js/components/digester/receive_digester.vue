    ...
    <div class="row flex-column-reverse flex-lg-row">
      ...
      <div class="col-lg-6 d-flex justify-content-start justify-content-lg-end">
        <button
          ...
          @click.prevent="receiveTransmittal"
        >
          <i data-feather="arrow-down-circle" class="mg-r-5"></i> Receive
        </button>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      dashboard: this.$env_Url + "/digester/transmittal",
      loading: true,
      items: [],
      itemFile: null,
      COCitemFile: null,
    ...
    async receiveTransmittal() {
      this.$confirm.require({
        ...
        accept: async () => {
          ...
          if (res.status === 200) {
            this.updmessage();
            window.location.href = this.$env_Url + "/digester/transmittal";
          } else {
